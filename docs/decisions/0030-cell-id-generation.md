...
Decision 0030 of 155, indexed in [CLAUDE.md](../../CLAUDE.md).

Previous: [2026-08-20 — Responsible leader for DCC attendance](0029-responsible-leader-for-dcc-attendance.md) | Next: [2026-08-20 — Cell attendance records members only](0031-cell-attendance-records-members-only.md)
