...
- **My People** (§3, §8). The person profile owes a DCC section: the classification and the Sundays behind it, from `GET /api/v1/dcc/people/{id}/attendance` (decision 0247), which ships waived to this block
