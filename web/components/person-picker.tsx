...
export function PersonPicker({
  ...
  const results = useQuery({
    ...
    // Add a Person, Add a Cell member, choosing whose network to view — names one
    // specific person for one operation rather than offering a place to look
    // around. Section 10 makes Cell membership independent of pastoral assignment,
