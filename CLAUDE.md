...
*Thirty-four distinct items across thirty-four bullets. One arrived on 2026-08-30 when the Cell half of a Network change was settled: whether Cell relationships owe a term in Section 4's backdate floor. Both halves of the change itself — leadership and membership — were settled and removed from this list rather than left on it annotated, because an item awaiting no ruling does not belong under this heading. Three arrived with the leadership
