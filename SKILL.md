...
not, because a submission is one leader's account of the whole meeting and coverage counts
recorded meetings rather than complete ones — so a correction resubmits marks a client had no way to read: the roster named the people
