...
**A `HELD` meeting is recorded for every member of the Cell on the meeting date, exactly
once, present or not.** This is the rule Section 7 and this section have each cited as
...
It follows from the zero-attendance case above rather than adding to it: a meeting the
leader attended alone "counts in the denominator, and every member is recorded as not
