...
some of whose months have not. *Some rather than most: the proportion changes through the
year, and the question exists the moment any one month of the selected year has not begun.* Nothing can reach it — neither yearly route exists — and it is
